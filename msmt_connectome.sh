...
desc_base=atlas-custom_subcort-tians3_cort-carpet
opt_desc="_sift2"
...
atlas_fpath=${atlas_dir}/sub-${sub_id}_atlas-custom_subcort-tians3_cort-carpet_atlas_warp-standard2acpc_dc_space-T1w.nii.gz
