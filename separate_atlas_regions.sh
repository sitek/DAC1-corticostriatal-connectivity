...
lut_fname=atlas-custom_subcort-tian${tian_scale}_cort-aud-vis-prefrontal_lut
lut_fpath=${deriv_dir}/atlas-custom_subcort-tian${tian_scale}_cort-aud-vis-prefrontal/${lut_fname}.tsv
