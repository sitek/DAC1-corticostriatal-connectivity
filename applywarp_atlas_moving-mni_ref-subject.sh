...
atlas_fpath=${deriv_dir}atlas-custom_subcort-tians3_cort-carpet/atlas-custom_subcort-tians3_cort-carpet_atlas_space-MNI152NLin6Asym.nii.gz
...
mkdir -p $out_dir
out_fpath=${out_dir}/sub-${sub_id}_atlas-custom_subcort-tians3_cort-carpet_atlas_warp-${xfm}_space-T1w.nii.gz
